...
export default function RecipientManagement() {
  ...
  const columns = [
    ...
    { header: 'Treating Hospital', accessor: 'hospital' },
    {
      header: 'Actions',
      render: (row) => (
        <button
  ...
  return (
    <AdminLayout role="ADMIN">
      <div className="space-y-6">
        <PageHeader
          title="Transplant Candidates"
          description="Monitor registered recipients, urgency priority, and treating facilities."
          actions={
        ...
        <DataTable
          ...
          data={recipients}
          loading={loading}
          searchPlaceholder="Search candidate, hospital..."
          searchValue={search}
          ...
          emptyDescription="New transplant candidate registrations will appear here."
        />

        {/* Modal View Details */}
        <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} title="Candidate Medical Profile">
          {selectedRecipient && (
            <div className="space-y-4 text-xs">
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1.5">
                ...
                <p>Treating Facility: {selectedRecipient.hospital} ({selectedRecipient.city}, {selectedRecipient.state})</p>
              </div>
